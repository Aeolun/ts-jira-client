...
var JiraApi = /** @class */ (function () {
     ...
     */
    JiraApi.prototype.makeRequestHeader = function (url, options) {
        if (options === void 0) { options = {}; }
        return __assign({ method: options.method || 'GET', url: url }, options);
    };
    /**
    ...
    JiraApi.prototype.doRequest = function (requestOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doPlainRequest(requestOptions)];
                    case 1:
                        response = _a.sent();
    ...
    JiraApi.prototype.doPlainRequest = function (requestOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                options = __assign(__assign({}, this.baseOptions), requestOptions);
                console.log('request', options);
                return [2 /*return*/, this.axios.request(options)];
            });
        });
    };
    /**
     ...
     */
    JiraApi.prototype.downloadUserAvatar = function (ownerId, avatarId) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doPlainRequest(this.makeRequestHeader(this.makeUri({
                            pathname: "/useravatar",
     ...
     * @param {number} avatarId - The avatar to download
     */
    JiraApi.prototype.downloadAvatar = function (avatarType, avatarId) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (typeof projectName === 'undefined' || projectName === null)
                            return [2 /*return*/, response.data.views];
                        rapidViewResult = response.data.views.find(function (x) { return x.name.toLowerCase() === projectName.toLowerCase(); });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data.sprints.pop()];
                }
            });
        });
    };
    ...
    JiraApi.prototype.searchJira = function (searchString, optional) {
        ...
        return this.doRequest(this.makeRequestHeader(this.makeUri({
            ...
            method: 'POST',
            data: __assign({ jql: searchString }, optional)
        }));
    };
    /** Create a Jira user
    ...
    JiraApi.prototype.deleteComponent = function (id, moveIssuesTo) {
        return this.doRequest(this.makeRequestHeader(this.makeUri({
            ...
            query: moveIssuesTo ? { moveIssuesTo: moveIssuesTo } : null
        }), {
            method: 'DELETE'
        }));
    };
    ...
    JiraApi.prototype.updateComment = function (issueId, commentId, comment, options) {
        ...
        return this.doRequest(this.makeRequestHeader(this.makeUri({
            ...
            data: __assign({ data: comment }, options),
            method: 'PUT'
        }));
    };
    /**
     ...
     */
    JiraApi.prototype.estimateIssueForBoard = function (issueIdOrKey, boardId, data) {
        return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
            pathname: "/issue/" + issueIdOrKey + "/estimation",
            query: {
                boardId: boardId
     ...
     * @param {string} body - value to set
     */
    JiraApi.prototype.rankIssues = function (data) {
        return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
            pathname: '/issue/rank'
        }), {
            method: 'PUT',
     ...
     */
    JiraApi.prototype.setBoardProperty = function (boardId, propertyKey, data) {
        return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
            pathname: "/board/" + boardId + "/properties/" + propertyKey
        }), {
            method: 'PUT',
     ...
     * @param {string} body - value to set, for objects make sure to stringify first
     */
    JiraApi.prototype.partiallyUpdateEpic = function (epicIdOrKey, data) {
        return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
            pathname: "/epic/" + epicIdOrKey
        }), {
            method: 'POST',
     ...
     * @param {string} body - value to set
     */
    JiraApi.prototype.rankEpics = function (epicIdOrKey, data) {
        return this.doRequest(this.makeRequestHeader(this.makeAgileUri({
